<template>
   <div class="discussWrap">
     <div class="top">
       <div class="name">
         <img :src="datas.avatarPath||'static/images/self@2x.png'" v-if="datas.isAnonymity===0&&datas.avatarPath&&datas.avatarPath!=='-'">
         <img :src="require('~/assets/img/self/self@2x.png')" v-else>
