...
<client-only>
   <section class="doubleWrpa">
     <backbar bgColor="#fff" leftColor="#333" @setHeight="setHeight" :shartOption="shartOption" title="屯茶季"
     ...
     <div>
       <div ref="topWrap">
        <div class="imgwrap">
          <img :src="require('~/assets/img/activity/doubleeleven/top-tun.png')" width="100%">
          <img :src="require('~/assets/img/activity/doubleeleven/toptitle-tun.png')" width="100%">
        </div>
        <div class="topgoodWrap">
          <div class="goods df">
            <div class="good" v-for="(item, index) in dataList" :key="index" @click="jumpDetail(item.productId,$event)">
        ...
        <div class="imggoodwrap">
          <img :src="require('~/assets/img/activity/doubleeleven/good.png')" width="100%" @click="jumpDetail('201910101703220275000017',$event)">
        </div>
       ...
       <div>
         <div class="acBlackWrap" v-for="label in tabsData" :key="label.key" :ref="`label${label.key}`">
           ...
           <div class="acgoods df">
             <div class="acgood" v-for="(item,index) in label.dataList" :key="index" @click="jumpDetail(item.productId,$event)">
...
export default {
  ...
  methods: {
    ...
    jumpDetail (productId, e) {
      ...
      const p = e.target.parentNode.offsetTop - e.screenY
...
.doubleWrpa{
  .mescroll{
    ...
    .topgoodWrap{
        width: 100%;
        // height: 385px;
        @include bg-image('activity/doubleeleven/topgoods-tun');
        padding: 0 5px 10px;
